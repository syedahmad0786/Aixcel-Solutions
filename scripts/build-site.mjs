...
register({
  ...
  description: "Nine verified revenue and creator operations systems demonstrating typed APIs, human approval, evaluation, observability, Postman, and Vercel deployment.",
  eyebrow: "Aixcel Labs · Agentic AI & LLM Systems Specialist",
  h1: "Nine working AI systems. One governed delivery standard.",
  ...
  aside: "Nine public demos are live, behavior-tested, and backed by separate source repositories. They use synthetic or licensed public records, not client production data.",
});
